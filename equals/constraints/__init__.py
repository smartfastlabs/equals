...
def constraint(func):
    ...
    def wrapped(self, *args, **kwargs):
        ...
        value = matcher_class(self, *args, **kwargs)
        return value
...
class Constraints(object):
    ...
    def greater_than_or_equal_to(self):
        from equals.constraints.numbers.greater_than_or_equal import (
            GreaterThanOrEqual,
        )  # noqa
    ...
    def less_than_or_equal_to(self):
        from equals.constraints.numbers.less_than_or_equal import (
            LessThanOrEqual,
        )  # noqa
